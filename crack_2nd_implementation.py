...
model = load_model('D:/Crack_detection/crack_model_2nd.h5')
...
Major_crack = prediction[0][0]

Minor_crack = prediction[0][1]
...
for i in range(0, len(result)):
    if(i==0 and result[i]==1.0):
       ...
       plt.imshow(img)
       plt.show()
       print("Crack_detection model has detected the" )
       #print(" \n")
       print("Major crack with probability {}%".format(Major_crack * 100))
      ...
      #plt.show()
       ...
       plt.imshow(im)
       plt.show()
       #if((cracked_prob * 100) > 70):
           #print("It is a MAJOR CRACK")
       #if((cracked_prob * 100) < 70):
           #print("it is a MINOR CRACK")
    if(i==1 and result[i]==1.0):
        ...
        print("Crack_detection model has detected the")
        #print(' \n')
        print("Minor crack with probability {}%".format(Minor_crack * 100))